...
namespace Bill_E_Proyecto_2022
{
    public partial class Form8 : Form
    {
        ...
        public Form8()
        {
            ...
            p = new PauseScreen(this, 350, 330, 65);
            lose = new PauseScreen(this, 350, 470, 65);
            win = new PauseScreen(this, 350, 470, 65);
...
//-----------------------------------------------------------------------------------------------------------------
        ...
        private void createBall(String type)
        {
            ...
            int y = rand.Next(100, this.ClientSize.Height - picBall.Height);
                    ...
                    if (p != x)
                    {
                        if (p is PictureBox && (string)p.Tag == tags[i] || p is PictureBox && p == Player || p is PictureBox && p == CContenedor)
                        {
                            if (x.Bounds.IntersectsWith(p.Bounds))
                            {
                                ...
                                int y = rand.Next(100, this.ClientSize.Height - x.Height);
        ...
        {
            p.setVisible(false);
            p.setImage(@"C:\Users\47338591\Pictures\Saved Pictures\IMG-20220418-WA0020.jpg");
            ...
            p.useEscape();
            p.setLocation(20, ((lose.getHeight() / 2) - (lose.getBHeight() / 2)) - 20);
        }
        ...
        private void loseConfig()
        {
            ...
            lose.setLocation(80, ((lose.getHeight() / 2) - (lose.getBHeight() / 2)) + 70);
        }
        ...
        private void winConfig()
        {
            ...
            win.setLocation(75, ((lose.getHeight() / 2) - (lose.getBHeight() / 2)) + 55);
            win.useTime(15);
        }
    }
}
